...
// Find the line with 'href={fileUrl}'
const urlIdx = content.lastIndexOf('href={fileUrl}');
if (urlIdx !== -1) {
  content = content.substring(0, urlIdx + 14);
  const correctEnding = `
              download
              title="Download"
...
`;
  ...
  console.log("Could not find 'href={fileUrl}'");
}
