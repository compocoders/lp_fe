      ...
      <div className="font-sans text-gray-800 bg-[#FAFCFA] overflow-clip selection:bg-[#FFC700] selection:text-white relative z-10">
        ...
        <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-sm shadow-sm py-3 md:py-4' : 'bg-transparent py-4 md:py-6'}`}>
          <div className="flex justify-between items-center px-6 md:px-16 max-w-7xl mx-auto">
            <div className="flex items-center gap-3 cursor-pointer hover:opacity-80 transition-opacity" onClick={() => navigate('/')}>
              <img src="/image/logo.svg" alt="L I K H Â Logo" className="w-8 h-8 md:w-10 md:h-10" />
              <span className="text-xl md:text-2xl font-black text-[#4A6447] tracking-[0.2em]">L I K H Â</span>
            </div>
              ...
              >
                ...
                <motion.div variants={fadeUpVariant} className="flex justify-center lg:justify-start mb-6">
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 border border-white/20 backdrop-blur-sm shadow-sm cursor-pointer hover:bg-white/15 transition-colors">
                    ...
                    <span className="text-white text-xs md:text-sm font-bold tracking-wide uppercase">Introducing L I K H Â Platform</span>
                  </div>
                </motion.div>
        ...
        <section className="py-20 md:py-32 px-5 md:px-10 text-center relative max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {[
              { name: "Sarah Jenkins", initial: "S", role: "High School Teacher", text: "L I K H Â has completely transformed how I organize my classroom. The AI features save me hours of prep time every week!" },
        ...
        <section className="py-20 md:py-32 px-5 md:px-10 max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: "What makes L I K H Â different from a standard LMS?", a: "L I K H Â fuses the organizational power of a traditional LMS with an integrated AI-Powered Learning Notebook and dynamic assessment tools, eliminating the need to juggle multiple applications." },
              ...
              { q: "Does the platform support technical programming courses?", a: "Yes! L I K H Â features a department-specific plugin architecture that includes an integrated online IDE for IT students, supporting languages like Java and C#." }
            ].map((faq, idx) => {
